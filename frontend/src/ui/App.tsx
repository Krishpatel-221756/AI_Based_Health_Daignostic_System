      ...
      {!currentUser ? (
        <div className="min-h-screen flex flex-col items-center justify-center p-4">
          <div className="mb-8 flex items-center gap-3">
            <div className="h-12 w-12 rounded-2xl bg-emerald-600 flex items-center justify-center text-2xl shadow-lg">
              🩺
            </div>
        ...
        <>
          ...
          <div className="mx-auto max-w-3xl px-4 py-8">
            ...
            {!isStarted ? (
              <div className="rounded-2xl bg-white p-12 shadow-sm ring-1 ring-gray-200 text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="mb-6 inline-flex h-20 w-20 items-center justify-center rounded-full bg-emerald-100 text-4xl text-emerald-600">
                  <span aria-hidden="true">🩺</span>
                </div>
                <h2 className="text-3xl font-bold text-gray-900 mb-4">
                  Ready to start, {currentUser.username}?
                </h2>
                <p className="text-lg text-gray-600 mb-8 max-w-md mx-auto">
                  Click the button below to start the diagnostic process. It only takes a few minutes to get an assessment.
                </p>
                <button
